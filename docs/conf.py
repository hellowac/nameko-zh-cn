# -*- coding: utf-8 -*-
#
# nameko documentation build configuration file, created by
# sphinx-quickstart on Thu Nov 21 14:32:44 2013.
#
...
# ones.
extensions = [
    "sphinx.ext.autodoc",  # 用于自动生成文档
    "sphinx.ext.todo",
    "sphinx.ext.coverage",
    "sphinx.ext.autosummary",  # 用于自动生成模块、类和方法的总结
    "sphinx.ext.viewcode",  # 生成源代码视图
    "sphinx.ext.intersphinx",
    "sphinxcontrib.spelling",
    "autoapi.extension",  # 自动生成代码的文档API
]
...
autoapi_keep_files = False  # autoapi不保留自动生成的文件
...
# html_title = None
html_title = "nameko - 一个用于 Python 的微服务框架"

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = None
html_short_title = "nameko"
...
html_js_files = ["open_in_new_tab.js"]
